...
if "staff_data" not in st.session_state:
    st.session_state.staff_data = pd.DataFrame([
        {"ลำดับ": 1, "ชื่อ - สกุล": "นายปัณณธร ศฤงคาร", "ตำแหน่ง": "พยาบาล"},
        {"ลำดับ": 2, "ชื่อ - สกุล": "นางสาวธัญญาลักษณ์ บุญประคม", "ตำแหน่ง": "พยาบาล"},
        {"ลำดับ": 3, "ชื่อ - สกุล": "นางสาวนิศารัตน์ วงศ์ใหญ่", "ตำแหน่ง": "พยาบาล"},
        {"ลำดับ": 4, "ชื่อ - สกุล": "นางสาวนิสารัตน์ ไชยวงศ์", "ตำแหน่ง": "พยาบาล"},
        {"ลำดับ": 5, "ชื่อ - สกุล": "นางสาวจิราภรณ์ บำรุงผล", "ตำแหน่ง": "พยาบาล"},
        {"ลำดับ": 6, "ชื่อ - สกุล": "นายนภัทร โขโยนะ", "ตำแหน่ง": "พยาบาล"},
        {"ลำดับ": 7, "ชื่อ - สกุล": "นางสาวพิมพ์มาดา ศรีคำวัง", "ตำแหน่ง": "พยาบาล"},
        {"ลำดับ": 8, "ชื่อ - สกุล": "นางสาวมารินี ทาปัญญา", "ตำแหน่ง": "พยาบาล"},
        {"ลำดับ": 9, "ชื่อ - สกุล": "นางสาวณัชพุนินทร์ ทองเพ็ญ", "ตำแหน่ง": "พยาบาล"},
        {"ลำดับ": 10, "ชื่อ - สกุล": "นางสาวสายแนน แสนสามารถ", "ตำแหน่ง": "ผู้ปฏิบัติฯ"},
    ])
