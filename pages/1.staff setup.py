...
if "staff_data" not in st.session_state:
    st.session_state.staff_data = pd.DataFrame([
        {"ลำดับ": 1, "ชื่อ-นามสกุล": "พญ.สมศรี (หัวหน้า RN)", "ตำแหน่ง": "RN", "กลุ่มเวร": "เช้า (จันทร์-ศุกร์)"},
        {"ลำดับ": 2, "ชื่อ-นามสกุล": "นース ไอด้า", "ตำแหน่ง": "RN", "กลุ่มเวร": "ทั่วไป"},
        {"ลำดับ": 3, "ชื่อ-นามสกุล": "พี่กบ (หัวหน้า PN)", "ตำแหน่ง": "PN", "กลุ่มเวร": "เช้า (จันทร์-ศุกร์)"},
        {"ลำดับ": 4, "ชื่อ-นามสกุล": "พี่เอื้อม (แม่บ้าน)", "ตำแหน่ง": "PN/แม่บ้าน", "กลุ่มเวร": "ทั่วไป"},
    ])
