...
with st.status("กำลังวิเคราะห์ข้อมูลด้วย Gemini AI...", expanded=True) as status:
    ...
    time.sleep(1.5)
    st.write("👾พยาบาลเวรเช้า(รวมหัวหน้าพยาบาล จ-ศ 3 คน เวรบ่าย 2 คน เวรดึก 1 คน ส-อ พยาบาล 1 คน", value=True)
    time.sleep(1.5)
    st.write("ผู้ช่วยพยาบาลเวรเช้า(รวมหัวหน้าผู้ช่วยพยาบาล จ-ศ 2 คน เวรบ่าย 1 คน เวรดึก 1 คน ส-อ ผู้ช่วยพยาบาล 1 คน", value=True)
    time.sleep(1.5)
